...
testing plate-form for techniques developed around SMT, but it is sufficienctly
...
method basically builds several interpollants from a unique proof.  In the Rodin
plugin to SMT~\cite{Deharbe1}, proofs from veriT are used as a mean to quickly
